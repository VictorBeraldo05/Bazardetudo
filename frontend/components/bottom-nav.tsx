...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-4 left-1/2 z-50 w-[calc(100%-1.25rem)] max-w-lg -translate-x-1/2 rounded-[1.75rem] border border-white/30 bg-[#111111] px-2 py-2 text-white shadow-2xl md:hidden">
